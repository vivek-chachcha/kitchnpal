...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Spanned spanned = Html.fromHtml(getString(R.string.register_help_text));
        registerButton.setText(spanned);
        ...
        registerButton.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                final View view1 = li.inflate(R.layout.register_popup, null);
                builder.setTitle("Register")
                        .setView(view1)
                        .setPositiveButton("Register", new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int id) {
                                User user = User.getInstance();
                                AutoCompleteTextView email = (AutoCompleteTextView) view1.findViewById(R.id.email_register);
                                EditText password = (EditText) view1.findViewById(R.id.password_register);
    ...
    private void attemptLogin() {
        ...
        if (TextUtils.isEmpty(email)) {
            ...
            focusView = mEmailView;
            cancel = true;
        } else if (!dbHelper.checkUserPassword(email, password)) {
